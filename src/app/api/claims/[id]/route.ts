...
export async function GET(
  ...
  const claim = await prisma.claim.findUnique({
    ...
    include: {
      ...
      insuranceInvoice: { include: { arPayment: { select: { id: true, receivedAt: true, amount: true } }, claims: { include: { parts: true, labors: true, expenses: true, insurance: true, garage: true } } } },
